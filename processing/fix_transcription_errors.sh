...
PATTERN='Flexion|Flixian|Flixing|Fliction|Flippshen|Flexumian|Fletchian|Flicksheen|Flyzion|Flyxen|Flyxian|Flyxionn|Flyxionne|Flykshun|Flykshion|Flikshun|Flikzion|Flikxion|Fleksion|Fleksian|Flextion|Flicksion|Flickzion|Flickxion|Fleksheen|Flekshun|Flekzion|Flixion|Flixyon|Flixxon|Flixionne|Flyxionu|Flick Sheenan|Flixan|Flickshen|Flickshin'
